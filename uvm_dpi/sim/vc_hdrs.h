...
typedef struct _vcs_dpi_my_ctrl_s	my_ctrl_s;
typedef struct _vcs_dpi_rsrc_msg_struct	rsrc_msg_struct;

struct	_vcs_dpi_my_ctrl_s	{
...
struct	_vcs_dpi_rsrc_msg_struct	{
 ...
 extern void* DPI_RGB888_to_YCbCr444_initialize(/* INPUT */void* existhandle);

 extern void DPI_RGB888_to_YCbCr444_terminate(/* INPUT */void* existhandle);

 extern void DPI_RGB888_to_YCbCr444(/* INPUT */void* existhandle, const /* OUTPUT */svOpenArrayHandle Y_dat_o, const /* OUTPUT */svOpenArrayHandle Cb_dat_o, const /* OUTPUT */svOpenArrayHandle Cr_dat_o, const /* INPUT */svOpenArrayHandle R_dat_o, const /* INPUT */svOpenArrayHandle G_dat_o, const /* INPUT */svOpenArrayHandle B_dat_o, const /* INPUT */my_ctrl_s *my_ctrl_struct);
